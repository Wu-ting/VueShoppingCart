              ...
              <div class="cart-item">
                ...
                <ul class="cart-item-list">
                  <li v-for="item in productList">
                    ...
                    <!-- 过滤器的使用，item.productPrice作为formatMoney的参数传入 -->
                    ...
                    <div class="cart-tab-5">
                      <div class="cart-item-operation">
                        <a href="javascript:void(0)" class="item-edit-btn" @click="delComfirm(item)">
            ...
            <div class="cart-foot-wrap">
              <div class="cart-foot-l">
                <div class="item-all-check">
                  <a href="javascript:void(0)">
                    <span class="item-check-btn" :class="{'check':checkAllFlag}" @click="checkAll(checkAllFlag = !checkAllFlag )">
                      <svg class="icon icon-ok"><use xlink:href="#icon-ok"></use></svg>
                    </span>
              ...
              <div class="cart-foot-r">
                ...
                <div class="next-btn-wrap">
                  <a href="#" class="btn btn--red" style="width: 200px">结账</a>
                </div>
              </div>
            </div>
          </div>
