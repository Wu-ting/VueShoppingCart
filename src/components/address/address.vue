      ...
      <div class="container">
        <div class="checkout-addr">
          ...
          <div class="addr-list-wrap">
            <div class="addr-list">
              <ul>
                <li v-for="(item,index) in filterAddress" :class="{'check':currentIndex==index}" @click="currentIndex=index">
                  <dl>
                    <dt>{{item.userName}}</dt>
            ...
            <div class="shipping-addr-more">
              <a class="addr-more-btn up-down-btn" href="javascript:" @click="loadMore(limitFlag)">
                more
                <i class="i-up-down">
          ...
          <div class="shipping-method-wrap">
            <div class="shipping-method">
              <ul>
                <li :class="{'check':shoppingMethod==1}" @click="shoppingMethod = 1">
                  <div class="name">标准配送</div>
                  <div class="price">Free</div>
                </li>
                <li :class="{'check':shoppingMethod==2}" @click="shoppingMethod = 2">
...
<script>
  export default {
    ...
    methods:{
      getAddressList(){
        this.$http.get('../../static/data/address.json').then(resp => {
          console.log(resp);
          if(resp.body.status === 0){
            this.addressList = resp.body.result;
